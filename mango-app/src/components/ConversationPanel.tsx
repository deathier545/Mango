...
type ConversationPanelProps = {
  ...
  logs: LogEntry[]
  /** Which sections to show. Defaults to both voice and system logs. */
  section?: 'both' | 'voice' | 'system'
}
...
export function ConversationPanel({
  ...
  const showVoice = section === 'both' || section === 'voice'
  const showSystem = section === 'both' || section === 'system'
  const gridClass = section === 'both' ? 'contentGrid' : 'contentGrid contentGridSingle'
          ...
          <header className="panelHead">
            <div>
              ...
              <p className="panelSub">
                Transcripts from wake word and push-to-talk (Alt+W). Use Chat for typed messages.
              </p>
            </div>
